...
static const PrefixEntry kProcFilterKeywords[] = {
    PE("lineage"), PE("Lineage"), PE("hertzify"), PE("Hertzify"), PE("omnirom"),
    PE("aospa"), PE("chaldeaprjkt"), PE("libremobileos"),
    { nullptr, 0 }
};
...
static const char* const kVintfFilterKeywords[] = {
    "lineage", "Lineage", "hertzify", "Hertzify", nullptr
};
#endif
...
static const char* const kSpoofedEmptyProps[] = {
    "ro.hertzify.version", "ro.hertzify.build.version",
    "init.svc_debug_pid.adb_root",
    "init.svc.adb_root", "service.adb.root",
    nullptr
};
